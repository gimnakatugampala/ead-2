      ...
      <Menu theme="light" mode="inline">
        ...
        <Menu.Item key="3">
          <NavLink to="/add-class">
            <span 
              className="icon"
              style={{
                background: page === "add-class" ? color : "",
              }}
              >{signin}</span>
        ...
        <Menu.Item key="5">
          <NavLink to="/instructors">
            ...
            className="icon"
            style={{
              background: page === "instructors" ? color : "",
            }}
            >{signin}</span>
        ...
        <Menu.Item key="6">
          <NavLink to="/add-instructor">
            <span 
              className="icon"
              style={{
                background: page === "add-instructor" ? color : "",
              }}
            >{signin}</span>
        ...
        <Menu.Item key="8">
          <NavLink to="/students">
            <span 
              className="icon"
              style={{
                background: page === "students" ? color : "",
              }}
            >{signin}</span>
        ...
        <Menu.Item key="11">
          <NavLink to="/my-classes">
            <span 
              className="icon"
              style={{
                background: page === "my-classes" ? color : "",
              }}
            >{signin}</span>
